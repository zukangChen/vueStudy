...
function parseCss(cssData, type) {
  ...
  const formatResult = JSON.stringify(result)
    .replace(/"/g, "'")
    .replace(/,/g, ', ')
  if (type === 'icon') {
...
const cssPath = '/t/font_1020340_i85dyk5033.css' // 线上web-pro的css地址
const cssWebPath = '/t/font_1020343_4mx6m9i38rj.css' // 线上web-pro-web地址
